...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StellarSyncServer.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncServer.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncServer.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncServer.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("StellarSyncServer.Models.FileCache", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncServer.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("StellarSyncServer.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncServer.Models.User", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncServer.Models.Auth", b =>
                {
                    b.HasOne("StellarSyncServer.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncServer.Models.ClientPair", b =>
                {
                    b.HasOne("StellarSyncServer.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncServer.Models.FileCache", b =>
                {
                    b.HasOne("StellarSyncServer.Models.User", "Uploader")
                        .WithMany()
