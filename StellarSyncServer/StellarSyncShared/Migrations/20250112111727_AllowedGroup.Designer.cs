...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StellarSyncShared.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaData", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaDataAllowance", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaDataFile", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaDataFileSwap", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaDataOriginalFile", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaDataPose", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("StellarSyncShared.Models.FileCache", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("StellarSyncShared.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("StellarSyncShared.Models.Group", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.GroupBan", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.GroupPair", b =>
                {
                    b.Property<string>("GroupGID")
                        .HasColumnType("character varying(20)")
                        .HasColumnName("group_gid");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.GroupPairPreferredPermission", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.GroupTempInvite", b =>
                {
                    b.Property<string>("GroupGID")
                        .HasColumnType("character varying(20)")
                        .HasColumnName("group_gid");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.User", b =>
                {
            ...
            modelBuilder.Entity("StellarSyncShared.Models.UserDefaultPreferredPermission", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("StellarSyncShared.Models.UserPermissionSet", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.UserProfileData", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("StellarSyncShared.Models.Auth", b =>
                {
                    b.HasOne("StellarSyncShared.Models.User", "PrimaryUser")
                        .WithMany()
                        .HasForeignKey("PrimaryUserUID")
                        .HasConstraintName("fk_auth_users_primary_user_uid");

                    b.HasOne("StellarSyncShared.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaData", b =>
                {
                    b.HasOne("StellarSyncShared.Models.User", "Uploader")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncShared.Models.CharaDataFile", b =>
                {
                    b.HasOne("StellarSyncShared.Models.FileCache", "FileCache")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncShared.Models.ClientPair", b =>
                {
                    b.HasOne("StellarSyncShared.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncShared.Models.Group", b =>
                {
                    b.HasOne("StellarSyncShared.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncShared.Models.GroupBan", b =>
                {
                    b.HasOne("StellarSyncShared.Models.User", "BannedBy")
                        .WithMany()
                        .HasForeignKey("BannedByUID")
                        .HasConstraintName("fk_group_bans_users_banned_by_uid");

                    b.HasOne("StellarSyncShared.Models.User", "BannedUser")
                        .WithMany()
                    ...
                    b.HasOne("StellarSyncShared.Models.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("StellarSyncShared.Models.GroupPair", b =>
                {
                    ...
                    b.HasOne("StellarSyncShared.Models.User", "GroupUser")
                        .WithMany()
