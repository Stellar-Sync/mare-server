...
public sealed class StellarConfigurationServiceServer<T> : IDisposable, IConfigurationService<T> where T : class, IStellarConfiguration
{
    ...
    public StellarConfigurationServiceServer(IOptionsMonitor<T> config)
    {
        _config = config;
