...
public partial class StellarHub
{
    ...
    public async Task<CharaDataFullDto?> CharaDataCreate()
    {
        ...
        _logger.LogCallInfo(StellarHubLogger.Args("SUCCESS", charaDataId));
    ...
    public async Task<bool> CharaDataDelete(string id)
    {
        ...
        try
        {
            _logger.LogCallInfo(StellarHubLogger.Args("SUCCESS", id));
        ...
        {
            _logger.LogCallWarning(StellarHubLogger.Args("FAILURE", id, ex.Message));
            return false;
        }
    }
    ...
    public async Task<List<CharaDataFullDto>> CharaDataGetOwn()
    {
        ...
        _logger.LogCallInfo(StellarHubLogger.Args("SUCCESS"));
    ...
    {
        _logger.LogCallInfo(StellarHubLogger.Args(id));
    ...
    public async Task<List<CharaDataMetaInfoDto>> CharaDataGetShared()
    {
        ...
        _logger.LogCallInfo(StellarHubLogger.Args("SUCCESS", sharedCharaData.Count));
    ...
    public async Task<CharaDataFullDto?> CharaDataUpdate(CharaDataUpdateDto updateDto)
    {
        ...
        if (anyChanges)
        {
            ...
            await DbContext.SaveChangesAsync().ConfigureAwait(false);
            _logger.LogCallInfo(StellarHubLogger.Args("SUCCESS", anyChanges));
        }
    ...
    private async Task<CharaData> GetCharaDataById(string id, string methodName)
    {
        ...
        if (splitid.Length != 2)
        {
            _logger.LogCallWarning(StellarHubLogger.Args("INVALID", id));
        ...
        if (charaData == null)
        {
            _logger.LogCallWarning(StellarHubLogger.Args("NOT FOUND", id));
        ...
        {
            _logger.LogCallWarning(StellarHubLogger.Args("UNAUTHORIZED", id));
