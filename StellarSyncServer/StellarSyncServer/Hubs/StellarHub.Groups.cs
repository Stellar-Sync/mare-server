...
public partial class StellarHub
{
    ...
    {
        _logger.LogCallInfo(StellarHubLogger.Args(dto, reason));
    ...
    public async Task<GroupJoinDto> GroupCreate()
    {
        ...
        _logger.LogCallInfo(StellarHubLogger.Args(gid));
    ...
    {
        _logger.LogCallInfo(StellarHubLogger.Args(dto, amount));
    ...
    public async Task<List<BannedGroupUserDto>> GroupGetBannedUsers(GroupDto dto)
    {
        ...
        _logger.LogCallInfo(StellarHubLogger.Args(dto, bannedGroupUsers.Count));
    ...
    public async Task<bool> GroupJoinFinalize(GroupJoinDto dto)
    {
        ...
        {
            _logger.LogCallInfo(StellarHubLogger.Args(aliasOrGid, "TempInvite", oneTimeInvite.Invite));
        ...
        _logger.LogCallInfo(StellarHubLogger.Args(aliasOrGid, "Success"));
    ...
    {
        _logger.LogCallInfo(StellarHubLogger.Args(dto, days, execute));
