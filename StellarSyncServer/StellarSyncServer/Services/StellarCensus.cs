...
public class StellarCensus : IHostedService
{
    ...
    private readonly ILogger<StellarCensus> _logger;
    ...
    public StellarCensus(ILogger<StellarCensus> logger)
    {
        _logger = logger;
    }
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _gauge = Metrics.CreateGauge("stellar_census", "stellar informational census data", new[] { "dc", "world", "gender", "race", "subrace" });
    }
